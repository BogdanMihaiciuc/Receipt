...
public class IndicatorFragment extends Fragment implements Utils.BackStack {
	...
	private class StartWorkingRunnable implements Runnable {
		...
		public void run() {
			...
			final FrameLayout actionBarRoot = (FrameLayout) activity.findViewById(R.id.LegacyActionBar);
			if (workingView == null) {
	...
	public void startWorking(Task workerTask) {
		...
		delayHandler.postDelayed(new StartWorkingRunnable(workerTask), WorkIndicatorAppearDelay);
	}
